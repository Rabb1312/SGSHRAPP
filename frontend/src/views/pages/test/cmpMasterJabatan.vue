        ...
        <div class="modal-body">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <CmpInputText
                    ...
                    "
                    @input="
                      (val) => (todo.jabatan = todo.jabatan.toUpperCase())
                    "
                  />
                </div>
              </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label for="example-nf-email">Level Atas</label>
                  <select
                    v-model="todo.level_atas"
                    :class="
                      errorField.level_atas
                        ? 'form-control input-lg input-error'
                        : 'form-control input-lg'
                    "
                  >
                    <option disabled value="">Pilih Level Atas</option>
                    <option value="ACCOUNT EKSEKUTIF">ACCOUNT EKSEKUTIF</option>
                    <option value="ACCOUNT AREA MANAGER">
                      ACCOUNT AREA MANAGER
                    </option>
                    <option value="NATIONAL SALES OPERATIONAL MANAGER">
                      NATIONAL SALES OPERATIONAL MANAGER
                    </option>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="col-md-6">
                <div class="form-group">
                  <label for="example-nf-email">Level Atas 1</label>
                  <select
                    v-model="todo.level_atas1"
                    :class="
                      errorField.level_atas1
                        ? 'form-control input-lg input-error'
                        : 'form-control input-lg'
                    "
                  >
                    <option disabled value="">Pilih Level Atas 1</option>
                    <option value="ACCOUNT SUPERVISOR">
                      ACCOUNT SUPERVISOR
                    </option>
                    <option value="NATIONAL SALES OPERATIONAL MANAGER">
                      NATIONAL SALES OPERATIONAL MANAGER
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label for="example-nf-email">Level Atas 2</label>
                  <select
                    v-model="todo.level_atas2"
                    :class="
                      errorField.level_atas2
                        ? 'form-control input-lg input-error'
                        : 'form-control input-lg'
                    "
                  >
                    <option disabled value="">Pilih Level Atas 2</option>
                    <option value="ACCOUNT AREA MANAGER">
                      ACCOUNT AREA MANAGER
                    </option>
                    <option value="GENERAL MANAGER">GENERAL MANAGER</option>
              ...
              <div class="col-xs-12">
                <button
                  ...
                  :disabled="
                    ...
                    todo.jabatan == null ||
                    todo.jabatan == '' ||
                    todo.level_atas == null ||
                    todo.level_atas == '' ||
                    todo.level_atas1 == null ||
                    todo.level_atas1 == '' ||
                    todo.level_atas2 == null ||
                    todo.level_atas2 == ''
                  "
                >
                  <i
...
export default {
  ...
  data() {
    return {
      ...
      json_fields: {
        jabatan: "jabatan", //sesuaikan database yang diperlukan
        level_atas: "level_atas",
        level_atas1: "level_atas1",
        level_atas2: "level_atas2",
      },
    };
  },
  async mounted() {
  ...
  methods: {
    ...
    async getDataExportExcel() {
      ...
      while (count > 0) {
        ...
        Object.keys(resData.results).forEach(function (key) {
          const countries_x = {
            ...
            jabatan: "'" + resData.results[key].jabatan,
            level_atas: resData.results[key].level_atas,
            level_atas1: resData.results[key].level_atas1,
            level_atas2: resData.results[key].level_atas2,
          };
      ...
      var countries_x = {
        nomor: "",
        jabatan: "Print Date",
        level_atas: mythis.formatDate(new Date()),
      };
      mythis.data_x_excel[baris_excel] = countries_x;
      ...
      mythis.nama_excelnya = "MASTER_JABATAN" + a + ".xls";
    ...
    saveTodo() {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          // };
          const config = "";
          var url = mythis.$root.apiHost + "api/hr_jabatan";
          axios
            .post(
              url,
              {
                jabatan: mythis.todo.jabatan,
                level_atas: mythis.todo.level_atas,
                level_atas1: mythis.todo.level_atas1,
                level_atas2: mythis.todo.level_atas2,
    ...
    getTable() {
      ...
      this.grid.updateConfig({
        ...
        server: {
          url: this.$root.apiHost + "api/hr_jabatan",
          then: (data) =>
            data.results.map((card) => [
              card.id,
              data.nomorBaris++ + 1,
              html(`<span class="pull-left">${card.jabatan}</span>`),
              html(`<span class="pull-left">${card.level_atas}</span>`),
              html(`<span class="pull-left">${card.level_atas1}</span>`),
              html(`<span class="pull-left">${card.level_atas2}</span>`),
            ]),
    ...
    deleteTodo(id) {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          // const config = "";
          axios
            .delete(mythis.$root.apiHost + `api/hr_jabatan/${id}`, config)
            .then((res) => {
    ...
    editTodo() {
      ...
      axios
        .put(
          mythis.$root.apiHost + "api/hr_jabatan/" + mythis.todo.id,
          {
            jabatan: mythis.todo.jabatan,
            level_atas: mythis.todo.level_atas,
            level_atas1: mythis.todo.level_atas1,
    ...
    async getData(id) {
      ...
      await axios
        .get(mythis.$root.apiHost + `api/hr_jabatan/${id}`, config)
        .then(async (res) => {
          //console.log(res.data.data);
          //mythis.acuanEdit = id;
          //mythis.todo = res.data.data;
          mythis.todo.id = id;
          mythis.todo.jabatan = res.data.data.jabatan;
          mythis.todo.level_atas = res.data.data.level_atas;
          mythis.todo.level_atas1 = res.data.data.level_atas1;
          mythis.todo.level_atas2 = res.data.data.level_atas2;
