        ...
        <div class="modal-body">
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label for="example-nf-email">Sallary</label>
                  <CmpInputText
                    type="text"
                    placeholder="Sallary"
                    v-model="todo.sallary"
                    :class="
                      errorField.sallary
                    ...
                    "
                    @input="
                      (val) => (todo.sallary = todo.sallary.toUpperCase())
                    "
                  />
                </div>
              </div>
...
export default {
  ...
  data() {
    return {
      ...
      json_fields: {
        cabang_id: "cabang_id", //sesuaikan database yang diperlukan
        sallary: "sallary",
        tahun: "tahun",
      },
    };
  ...
  methods: {
    // Add currency formatter helper method
    ...
    async getDataExportExcel() {
      ...
      while (count > 0) {
        ...
        Object.keys(resData.results).forEach(function (key) {
          const countries_x = {
            ...
            sallary: resData.results[key].sallary,
      ...
      var countries_x = {
        nomor: "",
        cabang_id: "Print Date",
        sallary: mythis.formatDate(new Date()),
      };
      mythis.data_x_excel[baris_excel] = countries_x;
      ...
      mythis.nama_excelnya = "MASTER_SALLARY" + a + ".xlsx";
    ...
    onChangeProfile() {
      console.log(this.todo.cabang_id);
      this.todo.cabang_id = this.selectedcabangs.nama_cabang;
    },
    ...
    saveTodo() {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          // };
          const config = "";
          var url = mythis.$root.apiHost + "api/hr_sallary";
          axios
            .post(
              url,
              {
                cabang_id: mythis.todo.cabang_id,
                sallary: mythis.todo.sallary,
      ...
      this.grid.updateConfig({
        ...
        columns: [
          ...
          "Cabang",
          {
            ...
            formatter: (cell) =>
              html(
                `<span class="pull-right">${mythis.formatCurrency(cell)}</span>`
              ),
          },
          "Tahun",
          {
        ...
        server: {
          url: this.$root.apiHost + "api/hr_sallary",
          then: (data) =>
    ...
    deleteTodo(id) {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          // const config = "";
          axios
            .delete(mythis.$root.apiHost + `api/hr_sallary/${id}`, config)
            .then((res) => {
    ...
    editTodo() {
      ...
      axios
        .put(
          mythis.$root.apiHost + "api/hr_sallary/" + mythis.todo.id,
          {
            cabang_id: mythis.todo.cabang_id,
            sallary: mythis.todo.sallary,
            tahun: mythis.todo.tahun,
    ...
    async getData(id) {
      ...
      await axios
        .get(mythis.$root.apiHost + `api/hr_sallary/${id}`, config)
        .then(async (res) => {
          //console.log(res.data.data);
          //mythis.acuanEdit = id;
          ...
          mythis.todo.sallary = res.data.data.sallary;
          mythis.todo.tahun = res.data.data.tahun;

          document.getElementById("cabang_id").focus(); // sets the focus on the input
