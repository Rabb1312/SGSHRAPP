            ...
            <div class="col-md-12">
              <div class="col-md-6">
                <div class="form-group">
                  <label for="example-nf-email">Kode Cabang</label>
                  <CmpInputText
                    id="inputA"
                    type="text"
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label for="example-nf-email">Nama Cabang</label>
                  <CmpInputText
                    type="text"
...
export default {
  ...
  data() {
    return {
      ...
      json_fields: {
        kode_cabang: "kode_cabang", //sesuaikan database yang diperlukan
  ...
  methods: {
    ...
    async getDataExportExcel() {
      ...
      while (count > 0) {
        ...
        Object.keys(resData.results).forEach(function (key) {
          const countries_x = {
            ...
            kode_cabang: "'" + resData.results[key].kode_cabang,
            nama_cabang: resData.results[key].nama_cabang,
          };
      ...
      var countries_x = {
        nomor: "",
        kode_cabang: "Print Date",
        nama_cabang: mythis.formatDate(new Date()),
      };
      mythis.data_x_excel[baris_excel] = countries_x;
      ...
      mythis.nama_excelnya = "MASTER_CABANG" + a + ".xls";
    ...
    saveTodo() {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          // };
          const config = "";
          var url = mythis.$root.apiHost + "api/hr_cabang";
          axios
            .post(
              url,
              {
    ...
    getTable() {
      ...
      this.grid.updateConfig({
        ...
        server: {
          url: this.$root.apiHost + "api/hr_cabang",
          then: (data) =>
    ...
    deleteTodo(id) {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          // const config = "";
          axios
            .delete(mythis.$root.apiHost + `api/hr_cabang/${id}`, config)
            .then((res) => {
    ...
    editTodo() {
      ...
      axios
        .put(
          mythis.$root.apiHost + "api/hr_cabang/" + mythis.todo.id,
          {
            kode_cabang: mythis.todo.kode_cabang,
            nama_cabang: mythis.todo.nama_cabang,
            userid: mythis.userid,
    ...
    async getData(id) {
      ...
      await axios
        .get(mythis.$root.apiHost + `api/hr_cabang/${id}`, config)
        .then(async (res) => {
          //console.log(res.data.data);
          //mythis.acuanEdit = id;
