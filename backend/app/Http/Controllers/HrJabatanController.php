...
class HrJabatanController extends Controller
{
    ...
    {
        $this->judul_halaman_notif = 'MASTER JABATAN';
    }
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        $data = $this->validate($request, [
            'jabatan' => 'required|unique:hr_jabatan,jabatan',
            'level_atas' => 'required',
            'level_atas1' => 'required',
            'level_atas2' => 'required',
        ]);
        try {
            $data['created_by'] = $user_id;
            $data['updated_by'] = $user_id;
            $todos = hr_jabatan::create($data);
    ...
    public function destroy(int $id)
    {
        ...
        try {
            $todo = hr_jabatan::findOrFail($id);

            hr_jabatan::where('id', $id)->update(['deleted_by' => $user_id]);
            $todo->delete();
    ...
    {
        try {
            $todos = hr_jabatan::findOrFail($id);
    ...
    public function update(Request $request, int $id): JsonResponse
    {
        ...
        try {
            ...
            hr_jabatan::where('id', $id)->update(['updated_by' => $user_id, 'updated_at' => date('Y-m-d H:m:s')]);
