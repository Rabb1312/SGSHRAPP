...
class HrUnitController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        $data = $this->validate($request, [
            'unit_number' => 'required|unique:hr_unit,unit_number',
            'unit_code' => 'required|unique:hr_unit,unit_code',
            'unit_name' => 'required',
        ]);
        try {
            $data['created_by'] = $user_id;
            $data['updated_by'] = $user_id;
            $todos = hr_unit::create($data);
    ...
    public function destroy(int $id)
    {
        ...
        try {
            $todo = hr_unit::findOrFail($id);

            hr_unit::where('id', $id)->update(['deleted_by' => $user_id]);
            $todo->delete();
    ...
    public function update(Request $request, int $id): JsonResponse
    {
        ...
        try {
            ...
            hr_unit::where('id', $id)->update(['updated_by' => $user_id, 'updated_at' => date('Y-m-d H:m:s')]);
