...
class HrCabangController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        $data = $this->validate($request, [
            'kode_cabang' => 'required|unique:hr_cabang,kode_cabang',
            'nama_cabang' => 'required|unique:hr_cabang,nama_cabang',
        ]);
        try {
            $data['created_by'] = $user_id;
            $data['updated_by'] = $user_id;
            $todos = hr_cabang::create($data);
    ...
    public function destroy(int $id)
    {
        ...
        try {
            $todo = hr_cabang::findOrFail($id);

            hr_cabang::where('id', $id)->update(['deleted_by' => $user_id]);
            $todo->delete();
    ...
    public function update(Request $request, int $id): JsonResponse
    {
        ...
        try {
            ...
            hr_cabang::where('id', $id)->update(['updated_by' => $user_id, 'updated_at' => date('Y-m-d H:m:s')]);
