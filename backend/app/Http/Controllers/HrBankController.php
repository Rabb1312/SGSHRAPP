...
class HrBankController extends Controller
{
    ...
    {
        $this->judul_halaman_notif = 'MASTER BANK';
    }
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        $data = $this->validate($request, [
            'bank_code' => 'required|unique:hr_bank,bank_code',
            'bank_name' => 'required',
        ]);
        try {
            $data['created_by'] = $user_id;
            $data['updated_by'] = $user_id;
            $todos = hr_bank::create($data);
    ...
    public function destroy(int $id)
    {
        ...
        try {
            $todo = hr_bank::findOrFail($id);

            hr_bank::where('id', $id)->update(['deleted_by' => $user_id]);
            $todo->delete();
    ...
    public function update(Request $request, int $id): JsonResponse
    {
        ...
        try {
            ...
            hr_bank::where('id', $id)->update(['updated_by' => $user_id, 'updated_at' => date('Y-m-d H:m:s')]);
